...
let Instructions = require("../models/Instructions");
...
router.post("/",(req,res)=>{
    let body = req.body;
    let object = new Instructions();
    object.id = 0;
    object.instruction = body.instruction;
    object.instructionsetid = body.instructionsetid;
